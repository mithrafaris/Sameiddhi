...
export default function AdminDashboard({
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-100 overflow-hidden font-sans">
      {/* Sidebar Navigation */}
      <div className="w-64 border-r border-slate-900 bg-slate-950 flex flex-col justify-between p-6 shrink-0 h-full">
        <div className="space-y-8">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide transition-all text-left cursor-pointer ${
                activeTab === 'products' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide transition-all text-left cursor-pointer ${
                activeTab === 'coupons' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide transition-all text-left cursor-pointer ${
                activeTab === 'banners' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide transition-all text-left cursor-pointer ${
                activeTab === 'reviews' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide text-slate-400 hover:text-red-400 hover:bg-red-950/20 transition-all cursor-pointer text-left"
        >
      ...
      <div className="flex-1 flex flex-col overflow-y-auto p-8 bg-slate-900/10">
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'dashboard' && (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-1">REAL-TIME BUSINESS TELEMETRY</p>
              </div>

              {/* Stats Bar */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="glass-card p-5 rounded-2xl border border-slate-800/80 bg-slate-900/10 space-y-2">
              ...
              <div className="glass-card p-6 rounded-3xl border border-slate-800/80 bg-slate-900/10 space-y-6">
                  ...
                  {chartHeights.map((val, idx) => (
                    <div key={idx} className="flex-1 flex flex-col items-center gap-3 h-full justify-end">
                      <motion.div
                        ...
                        className="w-full rounded-t-xl bg-gradient-to-t from-purple-600 to-indigo-600 shadow-lg shadow-purple-500/15"
                      />
          ...
          {activeTab === 'users' && (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE SYSTEM USERS AND ACCESS STATES</p>
              </div>

              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {users.map(user => (
                      <tr key={user._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        <td className="px-6 py-4 font-bold text-white uppercase">{user.name}</td>
                        <td className="px-6 py-4 text-slate-400 font-mono">{user.email}</td>
                        <td className="px-6 py-4 text-slate-300">₹{(user.wallet || 0).toFixed(2)}</td>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE STORE ITEM DEFINITIONS AND STOCKS</p>
                </div>
                <button
                  onClick={() => {
                    setEditProductId(null);
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 px-4 py-2 text-xs font-bold text-white transition-colors cursor-pointer"
                >
                ...
                {showAddForm && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <motion.form
                      ...
                      className="glass-card max-w-md w-full p-6 rounded-3xl border border-slate-800 space-y-4"
                    >
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full rounded-xl bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-slate-200 focus:outline-none"
                            />
                          </div>
                          <div className="space-y-1">
                        ...
                        <div className="space-y-1">
                          ...
                          <textarea
                            ...
                            className="w-full rounded-xl bg-slate-950 border border-slate-800 p-3 text-xs text-slate-200 focus:outline-none"
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4 justify-end pt-2">
                        ...
                        <button
                          type="submit"
                          className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-xs font-semibold text-white"
                        >
              ...
              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {products.map(p => (
                      <tr key={p._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        <td className="px-6 py-4">
                          <img
                            src={p.images[0] || 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop'}
                            alt="" className="h-8 w-8 object-cover rounded-lg border border-slate-800"
                          />
                        </td>
                        <td className="px-6 py-4 font-bold text-white uppercase">{p.productName}</td>
                        <td className="px-6 py-4 text-slate-400 uppercase tracking-wide text-[10px]">{p.category?.categoryName || 'General'}</td>
                        <td className="px-6 py-4 text-slate-300 font-bold">₹{p.price.toLocaleString('en-IN')}</td>
                        <td className="px-6 py-4">
                          <span className={`font-mono ${p.stock <= 5 ? 'text-red-400 font-bold' : 'text-slate-300'}`}>{p.stock} units</span>
                        </td>
                        <td className="px-6 py-4">
                          <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider ${
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer bg-slate-900/50 hover:bg-slate-800 text-slate-300 border border-slate-800"
                            >
          ...
          {activeTab === 'orders' && (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE CUSTOMER PURCHASES AND LOGISTICS</p>
              </div>
              ...
              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {orders.map(order => (
                      <tr key={order._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        <td className="px-6 py-4 font-mono font-bold text-purple-400">#{order.orderId}</td>
                        ...
                        <td className="px-6 py-4 text-slate-300 font-bold">₹{order.totalAmount.toLocaleString('en-IN')}</td>
                        <td className="px-6 py-4 text-slate-500 font-bold uppercase text-[9px]">{order.paymentMethod}</td>
                        <td className="px-6 py-4">
                          <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider ${
          ...
          {activeTab === 'reports' && (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-1">GENERATE AND EXPORT ANALYTICS DOCUMENTS</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="glass-card p-6 rounded-3xl border border-slate-800/80 bg-slate-900/10 flex flex-col justify-between items-start space-y-6">
                  <div className="space-y-2">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block">PDF FORMAT</span>
                  ...
                  <a
                    ...
                    target="_blank"
                    className="w-full inline-flex items-center justify-center rounded-xl bg-purple-600 hover:bg-purple-500 py-3 text-xs font-semibold text-white transition-colors"
                  >
                ...
                <div className="glass-card p-6 rounded-3xl border border-slate-800/80 bg-slate-900/10 flex flex-col justify-between items-start space-y-6">
                  <div className="space-y-2">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block">XLSX SHEET</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                ...
                <div className="glass-card p-6 rounded-3xl border border-slate-800/80 bg-slate-900/10 flex flex-col justify-between items-start space-y-6">
                  ...
                  <a
                    ...
                    className="w-full inline-flex items-center justify-center rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-800 py-3 text-xs font-semibold text-white transition-colors"
                  >
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE PRODUCT CLASSIFICATIONS</p>
                </div>
                <button
                  onClick={() => {
                    setEditCategoryId(null);
                ...
                {showCategoryForm && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <motion.form
                      ...
                      className="glass-card max-w-sm w-full p-6 rounded-3xl border border-slate-800 space-y-4"
                    >
                      <div className="pb-2 border-b border-slate-800 flex justify-between items-center">
                        <h4 className="text-sm font-bold text-white uppercase tracking-wider">
                          {editCategoryId ? 'Edit Category' : 'New Category'}
                        </h4>
                        <button type="button" onClick={() => setShowCategoryForm(false)} className="text-slate-500 hover:text-white">✕</button>
                      </div>
                      ...
                      <div className="flex gap-4 justify-end pt-2">
                        <button
                          ...
                          className="px-4 py-2 rounded-xl border border-slate-800 text-xs text-slate-400 hover:text-white cursor-pointer"
                        >
                          Cancel
                        </button>
                        <button
              ...
              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {categories.length === 0 ? (
                      <tr><td colSpan={4} className="text-center py-6 text-slate-500 text-xs">No categories found.</td></tr>
                    ) : categories.map(c => (
                      <tr key={c._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        <td className="px-6 py-4">
                          <img
                        ...
                        <td className="px-6 py-4 text-slate-400 max-w-[200px] truncate" title={c.description}>{c.description || 'No description'}</td>
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              onClick={() => {
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE DISCOUNT CODES AND PROMOTIONS</p>
                </div>
                <button
                  onClick={() => {
                    setEditCouponId(null);
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    ...
                    >
                      <div className="pb-2 border-b border-slate-800 flex justify-between items-center">
                        ...
                        <button type="button" onClick={() => setShowCouponForm(false)} className="text-slate-500 hover:text-white">✕</button>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full rounded-xl bg-slate-950 border border-slate-800 px-3 py-2 text-xs text-slate-200 focus:outline-none uppercase"
                            />
                          </div>
                          <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-slate-400 uppercase">Min Spend (₹)</label>
                            <input
                          ...
                          <div className="space-y-1">
                            <label className="text-[10px] font-bold text-slate-400 uppercase">Max Cap (₹)</label>
                            <input
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-slate-400 uppercase">Expiry Date (DD-MM-YYYY)</label>
                          <input
              ...
              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {coupons.length === 0 ? (
                      <tr><td colSpan={6} className="text-center py-6 text-slate-500 text-xs">No coupons found.</td></tr>
                    ) : coupons.map(c => (
                      <tr key={c._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        ...
                        <td className="px-6 py-4 text-slate-300">₹{c.minValue}</td>
                        <td className="px-6 py-4 text-slate-300">₹{c.maxValue}</td>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-semibold mt-1">MANAGE HOMEPAGE CAROUSEL BANNERS</p>
                </div>
                <button
                  onClick={() => {
                    setEditBannerId(null);
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    ...
                    >
                      <div className="pb-2 border-b border-slate-800 flex justify-between items-center">
                        ...
                        <button type="button" onClick={() => setShowBannerForm(false)} className="text-slate-500 hover:text-white">✕</button>
                      </div>

                      <div className="space-y-3">
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-slate-400 uppercase">Banner Name (Internal)</label>
                          <input
              ...
              <div className="glass-card rounded-3xl border border-slate-800/80 bg-slate-900/10 overflow-hidden">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {banners.length === 0 ? (
                      <tr><td colSpan={5} className="text-center py-6 text-slate-500 text-xs">No banners found.</td></tr>
                    ) : banners.map(b => (
                      <tr key={b._id} className="border-b border-slate-900 text-xs hover:bg-slate-900/10 transition-colors">
                        <td className="px-6 py-4">
                          <img
                            src={b.image || 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop'}
                            alt="" className="h-8 w-16 object-cover rounded-lg border border-slate-800"
                          />
                        </td>
                        <td className="px-6 py-4 font-bold text-white uppercase">{b.bannerName}</td>
                        <td className="px-6 py-4 text-slate-300">{b.title}</td>
                        <td className="px-6 py-4 text-slate-400">{b.subtitle}</td>
                        <td className="px-6 py-4 text-right">
                          <div className="flex gap-2 justify-end">
                            <button
                              onClick={() => {
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm text-slate-400">
                    ...
                    <tbody className="divide-y divide-slate-800/50">
                      {reviews.length === 0 ? (
                        <tr>
                          <td colSpan={6} className="px-6 py-8 text-center text-slate-500 font-medium">No reviews found</td>
                        </tr>
                      ) : (
                        reviews.map((r) => (
                          <tr key={r._id} className="hover:bg-slate-900/30 transition-colors">
                            ...
                            <td className="px-6 py-4 text-slate-400 truncate max-w-[200px]">{r.comment}</td>
          ...
          {showReviewForm && editReviewData && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
              <div className="glass-card w-full max-w-lg rounded-3xl border border-slate-800 p-6 md:p-8">
                <h3 className="text-xl font-bold text-white uppercase tracking-wide mb-6">Edit Review</h3>
                <form onSubmit={handleSaveReview} className="space-y-4">
                  <div>
                    <label className="mb-2 block text-xs font-bold uppercase text-slate-400">Rating (1-5)</label>
                    <input
                      type="number"
                      min="1"
                      max="5"
                      ...
                      className="w-full rounded-xl border border-slate-800 bg-slate-900/50 p-3 text-sm text-slate-200 focus:border-purple-500 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="mb-2 block text-xs font-bold uppercase text-slate-400">Comment</label>
                    <textarea
                      required
                      rows={4}
                      value={reviewComment}
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <button
                      type="submit"
                      className="flex-1 rounded-xl bg-purple-600 py-3 text-sm font-bold text-white hover:bg-purple-500 transition-colors"
                    >
                      Save Changes
                    </button>
                  </div>
